...
- GxP 21 CFR Part 11
- **AWS Generative AI Best Practices Framework v2** (June 2024) — 110 controls for **Amazon Bedrock** and **Amazon SageMaker AI** covering accuracy, fairness, privacy, resilience, responsible AI, safety, security, sustainability
...
## Common Controls Library (June 2024)
...
- **Don't confuse Audit Manager with AWS Config** — Config evaluates resource compliance against rules; Audit Manager aggregates evidence from Config, CloudTrail, Security Hub, and License Manager into audit-ready reports
- **Don't confuse Audit Manager with AWS Artifact** — Artifact provides AWS's own compliance reports/certifications (SOC, ISO); Audit Manager helps you audit **your** workloads
- **Audit Manager does NOT remediate** — it only collects evidence and generates reports. If a question asks about auto-remediation, the answer is Config rules with remediation actions or Systems Manager
- **Conformance Packs ≠ full replacement** — while AWS recommends them as the successor, they collect less exhaustive evidence (only Config rule evaluations, no CloudTrail logs or Security Hub findings)
- **Don't confuse Audit Manager with Security Hub** — Security Hub is a security findings aggregator (CSPM); Audit Manager packages evidence for formal audits
- **Audit Manager is being deprecated for new customers** — don't pick it as the answer for a brand-new compliance program starting after April 30, 2026; use Conformance Packs instead
